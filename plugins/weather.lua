...
local access_token = "1962431895.1677ed0.9d430fe3c8ba4560b9a3556914406fd9" -- your api key
local function instagramUser(msg, query)
	...
	if res ~= 200 then
		return "لا يـوجـد اتـصـال️"
    end
	local jdat = json:decode(jstr)
	if #jdat.data == 0 then
		send_msg(receiver,"#عذرا\n❌ لم يتم العثور ع يوزر",ok_cb,false)
	end
